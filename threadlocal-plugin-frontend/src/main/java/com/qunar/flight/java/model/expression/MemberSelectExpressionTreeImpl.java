...
public class MemberSelectExpressionTreeImpl extends AbstractTypedTree implements MemberSelectExpressionTree {
    ...
    public MemberSelectExpressionTreeImpl(@Nullable ArrayTypeTreeImpl nestedDimensions, InternalSyntaxToken dotToken,
    ...
    public MemberSelectExpressionTreeImpl(ExpressionTree expression, InternalSyntaxToken dotToken,
    ...
    public Iterable<Tree> children() {
        return Iterables.concat(annotations, Lists.newArrayList(expression, dotToken, identifier));
    }
}
