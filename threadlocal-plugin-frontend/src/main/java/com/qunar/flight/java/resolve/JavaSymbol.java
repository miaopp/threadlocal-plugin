...
public class JavaSymbol implements Symbol {
    ...
    /**
     * Represents a field, enum constant, method or constructor parameter, local variable, resource variable or
     * exception parameter.
     */
    ...
    public static class MethodJavaSymbol extends JavaSymbol implements MethodSymbol {
        ...
        public Boolean checkOverridingParameters(MethodJavaSymbol overridee, JavaType.ClassJavaType classType) {
            ...
            for (int i = 0; i < getParametersTypes().size(); i++) {
                ...
                if (paramOverrider.isUnknown()) {
                    // FIXME : complete symbol table should not have unknown types and generics should be handled
                    // properly for this.
                    return null;
                }
                ...
                if (classType instanceof JavaType.ParametrizedTypeJavaType) {
                    overrideeType = ((JavaType.ParametrizedTypeJavaType) classType).typeSubstitution
                            .substitutedType(overrideeType);
        ...
        public List<Type> thrownTypes() {
            return Lists.<Type> newArrayList(((JavaType.MethodJavaType) super.type).thrown);
        }
    ...
    public static class TypeVariableJavaSymbol extends TypeJavaSymbol {
        ...
        public ClassTree declaration() {
            ...
            // This probably implies to refactor this class to not inherit form TypeJavaSymbol and/or to implement its
            // dedicated interface
            return null;
        }
