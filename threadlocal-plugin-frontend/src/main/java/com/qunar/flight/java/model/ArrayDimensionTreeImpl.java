...
public class ArrayDimensionTreeImpl extends JavaTree implements ArrayDimensionTree {
    ...
    public ArrayDimensionTreeImpl(SyntaxToken openBracketToken, @Nullable ExpressionTree expression,
    ...
    public ArrayDimensionTreeImpl(List<AnnotationTreeImpl> annotations, SyntaxToken openBracketToken,
            @Nullable ExpressionTree expression, SyntaxToken closeBracketToken) {
