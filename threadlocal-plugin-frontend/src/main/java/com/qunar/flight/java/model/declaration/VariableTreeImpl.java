...
import com.qunar.flight.plugins.java.api.tree.InferedTypeTree;
...
public class VariableTreeImpl extends JavaTree implements VariableTree {
    ...
    public VariableTreeImpl(Kind kind, ModifiersTree modifiers, IdentifierTree simpleName,
    ...
    public VariableTreeImpl completeModifiersAndType(ModifiersTreeImpl modifiers, TypeTree type) {
        return completeModifiers(modifiers).completeType(type);
    }

    public VariableTreeImpl completeTypeAndInitializer(TypeTree type, InternalSyntaxToken equalToken,
    ...
    public Iterable<Tree> children() {
        return Iterables.concat(Lists.newArrayList(modifiers, type, simpleName),
