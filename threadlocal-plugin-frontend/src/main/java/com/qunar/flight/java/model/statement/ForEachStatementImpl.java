...
public class ForEachStatementImpl extends JavaTree implements ForEachStatement {
    ...
    public ForEachStatementImpl(InternalSyntaxToken forKeyword, InternalSyntaxToken openParenToken,
    ...
    public Iterable<Tree> children() {
        return Lists.newArrayList(forKeyword, openParenToken, variable, colonToken, expression, closeParenToken,
                statement);
    }
