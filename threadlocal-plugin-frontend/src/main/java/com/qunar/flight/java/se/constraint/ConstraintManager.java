 ...
 */
package com.qunar.flight.java.se.constraint;

import java.util.List;

import com.qunar.flight.java.se.Pair;
import com.qunar.flight.java.se.ProgramState;
import com.qunar.flight.java.se.SymbolicValueFactory;
import com.qunar.flight.java.se.symbolicvalues.NullCheckSymbolicValue;
import com.qunar.flight.java.se.symbolicvalues.RelationalSymbolicValue;
...
public class ConstraintManager {
    ...
    public void setValueFactory(SymbolicValueFactory valueFactory) {
        Preconditions.checkState(symbolicValueFactory == null,
                "The symbolic value factory has already been defined by another checker!");
    ...
    private SymbolicValue createDefaultSymbolicValue(Tree syntaxNode) {
        SymbolicValue result;
        result = symbolicValueFactory == null ? new SymbolicValue(counter) : symbolicValueFactory.createSymbolicValue(
                counter, syntaxNode);
