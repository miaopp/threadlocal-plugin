...
import static com.qunar.flight.java.xml.XmlCheckUtils.nodeLine;
...
import com.qunar.flight.java.AnalyzerMessage.TextSpan;
...
public class XmlCheckContextImpl implements XmlCheckContext {
    ...
    public static AnalyzerMessage buildAnalyzerMessage(JavaCheck check, String message, Integer line,
            Iterable<XmlDocumentLocation> secondary, @Nullable Integer cost, File file) {
        AnalyzerMessage analyzerMessage = new AnalyzerMessage(check, file, line, message,
