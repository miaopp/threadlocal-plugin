...
import com.qunar.flight.plugins.java.api.tree.CaseGroupTree;
import com.qunar.flight.plugins.java.api.tree.CaseLabelTree;
...
public class CFG {
    ...
    private void buildForEachStatement(ForEachStatement tree) {
        // TODO(npe) One solution is to create a forstatement node depending on type of expression (iterable or array)
        // and build CFG from it.
