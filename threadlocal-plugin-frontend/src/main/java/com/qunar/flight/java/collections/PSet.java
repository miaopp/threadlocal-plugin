 ...
 */
package com.qunar.flight.java.collections;
...
public interface PSet<E> {
    ...
    /**
     * Performs the given action for each entry in this set until all elements have been processed or the action throws
     * an exception.
     */
