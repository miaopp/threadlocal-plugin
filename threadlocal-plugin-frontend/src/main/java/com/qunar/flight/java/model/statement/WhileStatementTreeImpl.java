...
public class WhileStatementTreeImpl extends JavaTree implements WhileStatementTree {
    ...
    public WhileStatementTreeImpl(InternalSyntaxToken whileKeyword, InternalSyntaxToken openParenToken,
    ...
    public Iterable<Tree> children() {
        return Lists.newArrayList(whileKeyword, openParenToken, condition, closeParenToken, statement);
    }
