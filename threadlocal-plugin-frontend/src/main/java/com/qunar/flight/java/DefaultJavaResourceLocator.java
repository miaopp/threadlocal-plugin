...
public class DefaultJavaResourceLocator implements JavaResourceLocator {
    ...
    public void scanFile(JavaFileScannerContext context) {
        ...
        org.sonar.api.resources.File currentResource = (org.sonar.api.resources.File) sensorContext
        ...
        if (javaFilesCache.hasSuppressWarningLines()) {
            suppressWarningsFilter.addComponent(currentResource.getEffectiveKey(),
                    javaFilesCache.getSuppressWarningLines());
        }
    }
}
