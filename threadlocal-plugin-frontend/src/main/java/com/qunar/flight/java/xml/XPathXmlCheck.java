...
public abstract class XPathXmlCheck implements XmlCheck {
    ...
    /**
     * Will be called only once by XmlCheck. Using {@link XmlCheckContext#compile(String)}, should compile all the fixed
     * XPath expressions which will be re-used when analyzing files.
     * 
     * @param context
     */
