...
public class JavaType implements Type {
    ...
    public boolean is(String fullyQualifiedName) {
        if (tag < CLASS) {
            ...
            return fullyQualifiedName.endsWith("[]")
                    && ((ArrayJavaType) this).elementType.is(fullyQualifiedName.substring(0,
                            fullyQualifiedName.length() - 2));
    ...
    public boolean isSubtypeOf(String fullyQualifiedName) {
        if (isTagged(ARRAY)) {
            return "java.lang.Object".equals(fullyQualifiedName)
                    || (fullyQualifiedName.endsWith("[]") && ((ArrayJavaType) this).elementType
                            .isSubtypeOf(fullyQualifiedName.substring(0, fullyQualifiedName.length() - 2)));
        } else if (isTagged(TYPEVAR)) {
    ...
    public boolean isPrimitiveWrapper() {
        ...
        return is("java.lang.Byte") || is("java.lang.Character") || is("java.lang.Short") || is("java.lang.Integer")
                || is("java.lang.Long") || is("java.lang.Float") || is("java.lang.Double") || is("java.lang.Boolean");
    }
    ...
    public static class ClassJavaType extends JavaType {
        ...
        public boolean isSubtypeOf(Type superType) {
            ...
            if (superType.isClass()) {
                ...
                return this.equals(superClassType) || this.equals(superClassType.erasure())
                        || superTypeIsSubTypeOf(superClassType);
            }
            return false;
        }
    ...
    public static class ArrayJavaType extends JavaType implements ArrayType {
        ...
        public boolean equals(Object obj) {
            ...
            return new EqualsBuilder().append(elementType, rhs.elementType).isEquals();
        }
    ...
    public static class MethodJavaType extends JavaType {
        ...
        public MethodJavaType(List<JavaType> argTypes, @Nullable JavaType resultType, List<JavaType> thrown,
                JavaSymbol.TypeJavaSymbol symbol) {
            super(METHOD, symbol);
    ...
    public static class WildCardType extends JavaType {
        ...
        public enum BoundType {
            UNBOUNDED("?"), SUPER("? super "), EXTENDS("? extends ");
        ...
        public WildCardType(JavaType bound, BoundType boundType) {
            super(WILDCARD, new JavaSymbol.WildcardSymbol(boundType == BoundType.UNBOUNDED ? boundType.toString()
                    : (boundType + bound.symbol.name())));
            this.bound = bound;
        ...
        public boolean isSubtypeOf(String fullyQualifiedName) {
            return "java.lang.Object".equals(fullyQualifiedName)
                    || (boundType == BoundType.EXTENDS && bound.isSubtypeOf(fullyQualifiedName));
        }
        ...
        public boolean isSubtypeOf(Type superType) {
            ...
            return "java.lang.Object".equals(superType.fullyQualifiedName())
                    || (boundType == BoundType.EXTENDS && bound.isSubtypeOf(superType));
        }
