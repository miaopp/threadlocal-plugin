...
import com.qunar.flight.java.ast.visitors.ComplexityVisitor;
...
public class DefaultJavaFileScannerContext implements JavaFileScannerContext {
    ...
    private AnalyzerMessage createAnalyzerMessage(JavaCheck javaCheck, Tree syntaxNode, String message,
            List<Location> secondary, @Nullable Integer cost) {
        AnalyzerMessage analyzerMessage = new AnalyzerMessage(javaCheck, file, AnalyzerMessage.textSpanFor(syntaxNode),
                message, cost != null ? cost : 0);
    ...
    public void reportIssue(JavaCheck javaCheck, Tree startTree, Tree endTree, String message) {
        sonarComponents.reportIssue(new AnalyzerMessage(javaCheck, file, AnalyzerMessage.textSpanBetween(startTree,
                endTree), message, 0));
    }
    ...
    public static class SEIssue {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(tree, seIssue.tree) && Objects.equals(message, seIssue.message)
