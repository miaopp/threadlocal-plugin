...
public class CaseLabelTreeImpl extends JavaTree implements CaseLabelTree {
    ...
    public CaseLabelTreeImpl(InternalSyntaxToken caseOrDefaultKeyword, @Nullable ExpressionTree expression,
    ...
    public Iterable<Tree> children() {
        return Iterables.concat(Collections.singletonList(caseOrDefaultKeyword),
