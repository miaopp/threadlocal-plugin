...
import com.qunar.flight.java.ast.parser.TypeUnionListTreeImpl;
...
import com.qunar.flight.java.syntaxtoken.FirstSyntaxTokenFinder;
...
public abstract class JavaTree implements Tree {
    ...
    /**
     * Creates iterable for children of this node. Note that iterable may contain {@code null} elements.
     *
    ...
    public static class CompilationUnitTreeImpl extends JavaTree implements CompilationUnitTree {
        ...
        public CompilationUnitTreeImpl(@Nullable PackageDeclarationTree packageDeclaration,
                List<ImportClauseTree> imports, List<Tree> types, SyntaxToken eofToken) {
        ...
        public Iterable<Tree> children() {
            Iterable<Tree> packageIterator = packageDeclaration == null ? Collections.<Tree> emptyList() : Collections
                    .<Tree> singletonList(packageDeclaration);
            return Iterables.concat(packageIterator, imports, types, Collections.<Tree> singletonList(eofToken));
        }
    ...
    public static class PackageDeclarationTreeImpl extends JavaTree implements PackageDeclarationTree {
        ...
        public PackageDeclarationTreeImpl(List<AnnotationTree> annotations, SyntaxToken packageKeyword,
                ExpressionTree packageName, SyntaxToken semicolonToken) {
        ...
        @Override
        public Iterable<Tree> children() {
            return Iterables.concat(annotations, Lists.newArrayList(packageKeyword, packageName, semicolonToken));
        }
    ...
    public static class ImportTreeImpl extends JavaTree implements ImportTree {
        ...
        public Iterable<Tree> children() {
            ...
            return Iterables.concat(Collections.singletonList(importToken),
    ...
    public static class ParameterizedTypeTreeImpl extends AbstractTypedTree implements ParameterizedTypeTree,
            ExpressionTree {
    ...
    public static class ArrayTypeTreeImpl extends AbstractTypedTree implements ArrayTypeTree {
        ...
        public ArrayTypeTreeImpl(@Nullable TypeTree type, List<AnnotationTreeImpl> annotations,
        ...
        public Iterable<Tree> children() {
            ...
            return Iterables.concat(
                    ...
                    annotations,
                    hasBrackets ? Lists.newArrayList(openBracketToken, closeBracketToken) : Collections
                            .singletonList(ellipsisToken));
        }
