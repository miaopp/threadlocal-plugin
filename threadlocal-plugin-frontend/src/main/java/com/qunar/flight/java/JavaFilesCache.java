...
import com.qunar.flight.java.model.LiteralUtils;
...
import com.qunar.flight.java.syntaxtoken.LastSyntaxTokenFinder;
...
public class JavaFilesCache extends BaseTreeVisitor implements JavaFileScanner {
    ...
    public void visitMethod(MethodTree tree) {
        parent.push(tree);
        String methodKey = currentClassKey.peek() + "#"
                + MethodSignaturePrinter.print(MethodSignatureScanner.scan(tree));
