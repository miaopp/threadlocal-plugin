...
public class AssertStatementTreeImpl extends JavaTree implements AssertStatementTree {
    ...
    public AssertStatementTreeImpl(InternalSyntaxToken assertToken, ExpressionTree condition,
    ...
    public AssertStatementTreeImpl complete(InternalSyntaxToken assertToken, ExpressionTree condition,
            InternalSyntaxToken semicolonToken) {
        this.assertToken = assertToken;
        this.condition = Preconditions.checkNotNull(condition);
        this.semicolonToken = semicolonToken;
    ...
    public Iterable<Tree> children() {
        return Iterables.concat(Lists.newArrayList(assertToken, condition),
