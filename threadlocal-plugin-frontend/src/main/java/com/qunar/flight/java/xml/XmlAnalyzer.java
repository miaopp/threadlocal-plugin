...
import com.qunar.flight.java.xml.maven.PomCheck;
import com.qunar.flight.java.xml.maven.PomCheckContext;
import com.qunar.flight.java.xml.maven.PomCheckContextImpl;
import com.qunar.flight.java.xml.maven.PomParser;
...
public class XmlAnalyzer {
    ...
    public void scan(Iterable<File> files) {
        ...
        ProgressReport progressReport = new ProgressReport("Report about progress of Xml analyzer",
