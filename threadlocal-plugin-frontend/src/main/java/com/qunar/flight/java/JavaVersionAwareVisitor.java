...
/**
 * Implementing this interface allows a check to be executed - or not - during analysis, depending of expected java
 * version. <br />
...
public interface JavaVersionAwareVisitor {
    /**
     * Control if the check is compatible with the java version of the project being analyzed. The version used as
     * parameter depends of the property <code>sonar.java.source</code> (6 or 1.6 for java 1.6, 7 or 1.7, etc.).
     *
     * @param version The java version of the sources
     * @return true if the check is compatible with detected java version and should be executed on sources, false
     *         otherwise.
     */
