 ...
 */
package com.qunar.flight.java.filters;
 ...
 * <p/>
 * Plugins, via {@link org.sonar.api.BatchExtension}s, must feed this filter by registering the lines in which are
 * covered by suppress warnings. Note that filters are disabled for the issues reported by end-users from UI or web
 * services.
 *
 * @since 3.6
 */
