 ...
 */
package com.qunar.flight.java.xml.maven;
...
import com.qunar.flight.java.xml.XmlCheckContextImpl;
...
public class PomCheckContextImpl extends XmlCheckContextImpl implements PomCheckContext {
    ...
    public PomCheckContextImpl(MavenProject project, Document document, File file, XPath xPath,
