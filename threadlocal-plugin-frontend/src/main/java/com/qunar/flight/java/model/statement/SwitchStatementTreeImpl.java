...
public class SwitchStatementTreeImpl extends JavaTree implements SwitchStatementTree {
    ...
    public SwitchStatementTreeImpl(InternalSyntaxToken switchKeyword, InternalSyntaxToken openParenToken,
            ExpressionTree expression, InternalSyntaxToken closeParenToken, InternalSyntaxToken openBraceToken,
            List<CaseGroupTreeImpl> groups, InternalSyntaxToken closeBraceToken) {
    ...
    public Iterable<Tree> children() {
        return Iterables.concat(
                Lists.newArrayList(switchKeyword, openParenToken, expression, closeParenToken, openBraceToken), cases,
