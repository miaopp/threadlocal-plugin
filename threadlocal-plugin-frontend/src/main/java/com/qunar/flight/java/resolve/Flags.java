...
public class Flags {
    ...
    /**
     * Flag that marks either a default method or an interface containing default methods. Warning : This value is not
     * compliant with openJDK (default is 1L<<43 and 1<<15 is MANDATE)
     */
