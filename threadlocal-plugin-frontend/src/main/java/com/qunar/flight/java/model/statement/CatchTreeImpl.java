...
public class CatchTreeImpl extends JavaTree implements CatchTree {
    ...
    public CatchTreeImpl(InternalSyntaxToken catchToken, InternalSyntaxToken openParenToken,
    ...
    public Iterable<Tree> children() {
        return Lists.newArrayList(catchToken, openParenToken, parameter, closeParenToken, block);
    }
