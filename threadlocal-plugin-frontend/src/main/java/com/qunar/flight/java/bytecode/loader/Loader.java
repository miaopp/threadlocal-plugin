 ...
 */
package com.qunar.flight.java.bytecode.loader;
...
interface Loader {
     ...
     * @return an <tt>URL</tt> object for reading the resource, or <tt>null</tt> if the resource could not be found
     ...
     *
     * @param name resource name
     * @return an array of <tt>byte</tt>s, or <tt>null</tt> if the resource could not be found or could not be loaded
     *         for some reason
     * @throws IllegalStateException if loader has been closed
     */
    ...
    /**
     * Closes this loader, so that it can no longer be used to load new resources. If loader is already closed, then
