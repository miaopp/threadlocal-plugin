...
public class SquidClassLoader extends ClassLoader implements Closeable {
    ...
    /**
     * Closes this class loader, so that it can no longer be used to load new classes or resources. Any classes or
     * resources that are already loaded, are still accessible.
     *
