 ...
 */
package com.qunar.flight.plugins.java.api.semantic;
...
public interface Type {
     ...
     * </pre></code>
     *
     * @param fullyQualifiedName fully qualified name to check. Use "[]" for arrays and the simple name for primitive
     *            type ("int", "byte"...).
     ...
     * <p>
     * This method will consider implemented interfaces as well as superclasses. <code><pre>
     *   Type type;
    ...
    /**
     * Check if this type has been resolved. Type can be unknown in incomplete part of Semantic Analysis or when
     * bytecode for a type is not provided and a method cannot be resolved.
     * 
