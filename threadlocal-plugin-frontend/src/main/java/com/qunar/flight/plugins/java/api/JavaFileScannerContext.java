...
public interface JavaFileScannerContext {
    ...
    void reportIssue(JavaCheck javaCheck, Tree tree, String message, List<Location> secondaryLocations,
    ...
    class Location {
        ...
        public boolean equals(Object o) {
            ...
            return Objects.equals(msg, location.msg) && Objects.equals(syntaxNode, location.syntaxNode);
        }
